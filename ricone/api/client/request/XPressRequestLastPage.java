 ...
 */
public class XPressRequestLastPage extends XRequest {
    private ServicePath servicePath;
    private String refId;
    private Integer schoolYear;
    private PagingInfo pagingInfo;

    private XPressRequestLastPage() {
    }
    ...
    public static class Builder extends PathVerifier {
        ...
        public XPressRequestLastPage build() throws InvalidPathException, MissingArgumentException {
            ...
            if(isMissingPagingInfo(this.servicePath)) {
            ...
            XPressRequestLastPage xPressRequest = new XPressRequestLastPage();
        ...
        @Override
        public boolean isMissingPagingInfo(ServicePath path) {
